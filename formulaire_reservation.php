...
<?php
  ...
  //========================
$id_reservation = $_GET['donnees']; 
$_SESSION['id_reservation'] = $id_reservation; // sera utilisé pour l'update de donnees du interprete
//echo $id_reservation;
$reservation_affiche = $connexion_bd->prepare('SELECT * FROM tble_reservation WHERE id_tble_reservation =' .$id_reservation);
$reservation_affiche->execute();
$donnees_reservation_affiche = $reservation_affiche->fetch();
...
$Tel_M =   valid_donnees($donnees_reservation_affiche['Numero de téléphone du client']);
$Tel_D  = valid_donnees($donnees_reservation_affiche['Numero de téléphone du client']);
$Num_fixe = valid_donnees($donnees_reservation_affiche['Numero de téléphone du client']);

	echo $Tel_M;
	

  
//print_r($donnees_reservation_affiche);	
...
<div class="col-lg-1"></div>
	...
	<label >Prenom</label>
      <input type="text" class="form-control" placeholder="Prenom" name="prenom" value="<?php echo  $donnees_reservation_affiche['Demandeur'];
?> " pattern="[a-zéèaA-Z- ]*" maxlenght ="20">
    </div>
    <div class="form-group col-lg-3">
	<label >Nom</label>
      <input type="text" class="form-control" placeholder="Nom" name="nom" value="<?php echo  $donnees_reservation_affiche ['Langues'];?>" pattern="[a-zéèaA-Z- ]*" maxlenght ="20">
	</div>
	
	<div class="form-group col-lg-3">
	<label >Email</label>
      <input type="email" class="form-control" placeholder="Email" name="email" value="<?php echo  $donnees_reservation_affiche['Email client'];
...
<div class="col-lg-9">
 <div class="form-group">
	...
	<?php echo $donnees_reservation_affiche['Langues'];?>
	</textarea>
  </div>
  </div>
  <div class="col-lg-1"></div>
...
<div class="col-lg-1"></div>	
  ...
  <div class="col-lg-1"></div>
    ...
    <div class="form-group col-lg-4">
      <label >Ville</label>
      <input type="text" class="form-control" name ="ville" value="<?php echo '' // $donnees_reservation_affiche['Ville'];?>" pattern="[a-zéèaA-Z- ]*">
    </div>
	
    <div class="form-group col-lg-3">
      <label >Pays</label>
	  <select  class="form-control" name="pays" value="<?php echo ''// $donnees_reservation_affiche['pays'];?> " >
    ...
    <div class="form-group col-lg-2">
      ...
      <input type="text" class="form-control" name="code_postal" value="<?php echo ''//$donnees_reservation_affiche['Code_postal'];?>" pattern="([0-9]{5})\s*">
    </div>
  ...
  <div class="form-group col-lg-9">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="commentaires" ><?php echo'' // $donnees_reservation_affiche['Commentaires'];?></textarea>
  </div>
